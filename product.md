...
| Reports | Installed in test | Manager-only visual business-performance report: equivalent monthly comparison, labeled projection, financial result, daily evolution, income/payment/expense composition and service/product highlights. Migration `039` and its manager/employee PostgreSQL acceptance are verified in test. |
