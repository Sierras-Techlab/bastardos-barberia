    ...
    <Dialog open onOpenChange={(open) => !open && !isSaving && onClose()}>
      <DialogContent className="rounded-[1.6rem] p-5 sm:max-w-md">
        <DialogHeader>
          ...
          <DialogTitle>Eliminar medio de pago</DialogTitle>
          <DialogDescription>
            ¿Querés eliminar “{method.name}” permanentemente? Sólo se eliminará
            si todavía no tiene ventas registradas.
          </DialogDescription>
        </DialogHeader>
        ...
        <DialogFooter className="-mx-5 -mb-5 mt-5 p-5">
          ...
          <Button
            ...
            className="rounded-xl"
          >
            {isSaving ? "Eliminando..." : "Eliminar medio de pago"}
          </Button>
        </DialogFooter>
      </DialogContent>
    </Dialog>
