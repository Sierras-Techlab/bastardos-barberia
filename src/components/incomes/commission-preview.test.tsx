...
const values = { employeeId: employee.id, customerId: null, serviceId: "service", products: [{ productId: "product", quantity: 1, grantFullCommission: true }], paymentMode: "cash" as const, payments: [{ method: "cash" as const, amount: 26000 }], grantFullServiceCommission: true };
