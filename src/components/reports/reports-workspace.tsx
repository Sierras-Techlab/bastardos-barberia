...
export function ReportsWorkspace({ initialReport, currentMonth, client = reportClient }: { initialReport: BusinessReport; currentMonth: string; client?: Pick<ReportClient, "get"> }) {
