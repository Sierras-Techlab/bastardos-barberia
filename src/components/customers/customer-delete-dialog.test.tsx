...
it("deletes only after explicit confirmation", async () => {
  ...
  render(<CustomerDeleteDialog customer={{ id: "id", firstName: "Ana", lastName: "Pérez", phone: "3515550101", email: null, visits: 0, createdAt: "2026-08-11T00:00:00.000Z" }} onClose={vi.fn()} onConfirm={onConfirm} />);
