...
export const buildIncomeMetricCards = (metrics: IncomeListMetrics, role: UserRole): IncomeMetricCard[] => role === "employee" ? [
  { label: "Total vendido", value: formatArs(metrics.total), detail: "Mis ingresos activos", tone: "dark" },
  ...
  { label: "Facturación bruta", value: formatArs(metrics.total), detail: "Ingresos activos", tone: "dark" },
