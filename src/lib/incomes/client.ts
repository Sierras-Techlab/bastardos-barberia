...
export type IncomeClient = { create(input: CreateIncomeInput): Promise<Income>; list(query: IncomeListQuery): Promise<PaginatedIncomes>; get(id: string): Promise<IncomeListItem>; void(id: string): Promise<IncomeListItem> };
