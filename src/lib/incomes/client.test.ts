...
it("creates, lists, gets and voids incomes without caching", async () => {
  ...
  const input = { requestId: "40000000-0000-4000-8000-000000000001", customerId: null, serviceId: "30000000-0000-4000-8000-000000000001", products: [], paymentMethod: "cash" as const };
