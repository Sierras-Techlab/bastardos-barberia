...
it("creates, lists, gets and voids incomes without caching", async () => {
  ...
  await incomeClient.create(input); await incomeClient.list({ page: 1, pageSize: 10, dateFrom: "2026-08-01", paymentMethodId: "60000000-0000-4000-8000-000000000003" }); await incomeClient.get("20000000-0000-4000-8000-000000000001"); await incomeClient.void("20000000-0000-4000-8000-000000000001");
