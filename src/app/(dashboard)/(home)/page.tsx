...
const Home = async () => {
  ...
  const [firstIncomePage, fixedOccurrences] = await Promise.all([
    ...
    listFixedOccurrences(user, { dateFrom: range.dateTo, dateTo: addDays(range.dateTo, 56) }),
  ]);
