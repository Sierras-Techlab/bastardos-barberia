...
const quickActions: QuickAction[] = [
  ...
  { label: "Gestionar cliente", icon: UserPlus, href: "/customers" },
  { label: "Registrar gasto", icon: MinusCircle, href: "#" },
  { label: "Cerrar caja", icon: Lock, href: "#" },
];
              ...
              <div className="mb-3 flex items-end justify-between gap-4">
                <div>
                  ...
                  <p className="text-xs text-muted-foreground">
                    Promedio por venta{" "}
                    {currencyFormatter.format(revenue.averageTicket)}
                  </p>
                </div>
                <p className="text-xs text-muted-foreground">
                  ...
                  <div className="mb-1 flex items-center justify-between gap-3 text-xs">
                    <div className="min-w-0">
                      ...
                      <p className="text-[10px] text-muted-foreground">
                        ...
                        {compactCurrencyFormatter.format(service.revenue)}
                      </p>
                    </div>
