...
import { getBuenosAiresToday } from "@/lib/dashboard/date";
...
const CustomersPage = async () => {
  ...
  const [customersData, paymentMethodsResponse, professionalList, fixedCustomerMonths] = await Promise.all([
    listCustomers(user),
    ...
    listFixedCustomerMonths(user, { period: today.slice(0, 7) }),
  ]);
