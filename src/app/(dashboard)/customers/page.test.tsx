...
const { requirePageUser, listCustomers, listPaymentMethods, listUsers, listFixedCustomerMonths } = vi.hoisted(() => ({
  ...
  listFixedCustomerMonths: vi.fn().mockResolvedValue([]),
}));
...
vi.mock("@/lib/fixed-customer-payments/service", () => ({ listFixedCustomerMonths }));
