...
- Income payments are normalized allocations whose positive cash/transfer amounts exactly equal the authoritative sale total. Commission bases, per-item rates/amounts/exception authorizers, total and barbershop net are immutable sale snapshots.
